...
" Editor
call <sid>hi('ColorColumn', s:none, colorColumn, 'none')
call <sid>hi('Cursor', s:voidSteel, s:voidBlack2, 'none')
call <sid>hi('CursorColumn', s:none, s:voidGray1, 'none')
call <sid>hi('CursorLine', s:none, s:voidGray3, 'none')
call <sid>hi('CursorLineNr', cursorLineNrFG, cursorLineNrBG, 'none')
...
call <sid>hi('IncSearch', searchFG, searchBG, 'none')
call <sid>hi('LineNr', s:voidGray3, lineNr, 'none')
...
call <sid>hi('ErrorMsg', s:voidBlack, s:voidSteel, 'none')
...
call <sid>hi('NonText', nonText, s:none, 'none')
